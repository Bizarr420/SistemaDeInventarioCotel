    ...
    <form method="POST" action="{{ route('products.store') }}" novalidate>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input id="internal_code" name="internal_code" type="text" value="{{ old('internal_code') }}"
            ...
            <div>
                ...
                <input id="part_number" name="part_number" type="text" value="{{ old('part_number') }}"
                       class="mt-1 block w-full rounded-md text-gray-900 border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500">
            ...
            <div>
                ...
                <input id="item" name="item" type="text" value="{{ old('item') }}"
                       class="mt-1 block w-full rounded-md text-gray-900 border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500">
            ...
            <div>
                ...
                <input id="name_item" name="name_item" type="text" required value="{{ old('name_item') }}"
                       class="mt-1 block w-full rounded-md text-gray-900 border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500">
            ...
            <div>
                ...
                <input id="cnd" name="cnd" type="text" value="{{ old('cnd') }}"
                       class="mt-1 block w-full rounded-md text-gray-900 border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500">
            ...
            <div>
                ...
                <input id="unit" name="unit" type="text" value="{{ old('unit') }}"
                       class="mt-1 block w-full rounded-md text-gray-900 border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500">
            ...
            <div>
                ...
                <input id="mac" name="mac" type="text" value="{{ old('mac') }}"
                       class="mt-1 block w-full rounded-md text-gray-900 border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500">

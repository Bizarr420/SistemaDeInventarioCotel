<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('users.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 transition ease-in-out duration-150">
                {{ __('Nuevo Usuario') }}
            </a>
        </div>
    </x-slot>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-4 text-center text-sm text-gray-500">{{ __('No hay usuarios') }}</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
